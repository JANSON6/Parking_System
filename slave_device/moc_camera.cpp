...
QT_MOC_LITERAL(1, 7, 18), // "gotOneRGBFrameData"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 5) // "image"

    },
    "Camera\0gotOneRGBFrameData\0\0image"
};
...
void Camera::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->gotOneRGBFrameData((*reinterpret_cast< QImage(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Camera::gotOneRGBFrameData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Camera::gotOneRGBFrameData(QImage _t1)
{
