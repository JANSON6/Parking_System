...
QT_MOC_LITERAL(1, 8, 10), // "gotCarType"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 4), // "type"
QT_MOC_LITERAL(4, 25, 11), // "gotCarPlate"
QT_MOC_LITERAL(5, 37, 8), // "carPlate"
QT_MOC_LITERAL(6, 46, 17), // "on_connectSucceed"
QT_MOC_LITERAL(7, 64, 11), // "on_recvData"
QT_MOC_LITERAL(8, 76, 13), // "on_sendCardId"
QT_MOC_LITERAL(9, 90, 2) // "id"

    },
    "NetWork\0gotCarType\0\0type\0gotCarPlate\0"
    "carPlate\0on_connectSucceed\0on_recvData\0"
    "on_sendCardId\0id"
};
...
void NetWork::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->gotCarType((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->gotCarPlate((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->on_connectSucceed(); break;
        case 3: _t->on_recvData(); break;
        case 4: _t->on_sendCardId((*reinterpret_cast< uint(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (NetWork::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetWork::gotCarType)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NetWork::gotCarPlate)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void NetWork::gotCarType(int _t1)
{
...
// SIGNAL 1
void NetWork::gotCarPlate(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
